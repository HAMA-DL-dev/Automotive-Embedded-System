...
class QCar():
    ...
    def read_encoder(self):
        ...
        try:
            ...
            print("This is related to HILS error !!!")
            print(h.get_error_message())
    ...
    def read_write_std(self, mtr_cmd, LEDs):
        ...
        except HILError as h:pass
            # print("HIL ERROR at : IO !!!")
            # print(h.get_error_message())
